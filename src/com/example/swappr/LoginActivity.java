...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor>, AsyncResponse {
	...
	public class UserLoginTask extends AsyncTask<Void, Void, String> {
		...
		protected String doInBackground(Void... params) {
			...
			HttpPost httppost = new HttpPost("http://192.168.1.7/swappr/public/api/login");
			HttpResponse response = null;
			InputStream instream = null;
			String responseText = null, token = null, result = null;
			...
			try {
				...
				JSONObject json = new JSONObject(responseText); // Convert
																// String to
																// JSON Object
				token = json.getString("token");
				// write response to log
				// Log.d("Http Post Response:", responseText);
		...
		protected void onPostExecute(final String token) {
			...
			if (!token.equals("invalid")) {
				...
				Toast.makeText(getApplicationContext(), "Invalid credentials provided.", Toast.LENGTH_LONG).show();
			}
		}
	...
	public void processFinish(String token) {
		...
		Toast.makeText(getApplicationContext(), (String) token, Toast.LENGTH_LONG).show();

		// pass token to next activity
	}
}
